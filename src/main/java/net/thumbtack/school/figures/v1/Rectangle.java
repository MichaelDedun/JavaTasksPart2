...
public class Rectangle {
    ...
    public boolean isIntersects(Rectangle rectangle) {
        return Math.max(leftTop.getX(), rectangle.leftTop.getX()) <=
                Math.min(rightBottom.getX(), rectangle.rightBottom.getX()) &&
                Math.max(leftTop.getY(), rectangle.leftTop.getY()) <=
                        Math.min(rightBottom.getY(), rectangle.rightBottom.getY());
    }
